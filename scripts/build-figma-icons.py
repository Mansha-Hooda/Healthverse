...
OUT = os.path.join(ROOT, "src", "components", "icons", "header.tsx")
...
ICONS = [
    ("IconArrowLeft", "Go back", simple, "arrow-left-02.svg"),
    ("IconLocation", "Location", simple, "location-06.svg"),
    ("IconCall", "Call support", simple, "call.svg"),
    (
        "IconWallet",
        "Wallet",
        composed,
...
HEADER = """// AUTO-GENERATED by scripts/build-figma-icons.py — do not edit by hand.
// Source: Figma "Health Verse Revamp_Jan25", header node 1061:19797.
...
def main():
    ...
    parts = [HEADER]
    for component, _purpose, builder, spec in ICONS:
...
"""
    ...
    with open(OUT, "w", encoding="utf-8") as fh:
        fh.write("".join(parts))
    print(f"wrote {os.path.relpath(OUT, ROOT)} ({len(''.join(parts)):,} chars)")
